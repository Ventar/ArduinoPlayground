#ifndef HomeControl_SensorTemperature_h
#define HomeControl_SensorTemperature_h
...
/**
 * Temperature Sensor based on the DHT22 module.
 */
class DHTTemperature : public SensorPassive {
 public:
  /**
   * Default constructor
   *
   ...
   * the programm.
   */
  DHTTemperature(DHT* dht) : SensorPassive(TEMPERATURE, FLOAT, "°C") { this->dht = dht; };
